    ...
    <div class="form-box">
        ...
        <div class="register-container" id="register">
            <form action="../actions/register_action.php" method="post">
                ...
                <div class="two-forms">
                    <div class="input-box">
                        <input type="text" class="input-field" placeholder="Firstname" name="first-name">
                        <i class="bx bx-user"></i>
                    </div>
                    <div class="input-box">
                        <input type="text" class="input-field" placeholder="Lastname" name="last-name">
                        <i class="bx bx-user"></i>
                    </div>
                </div>
                <div class="input-box">
                ...
                <div class="input-box">
                    <input type="password" class="input-field" placeholder="Confirm Password" name="confirm-pwd">
                    <i class="bx bx-lock-alt"></i>
                </div>
                <div class="input-box">
                    <input type="submit" class="submit" value="Register" name="register-submit">
                </div>
                <div class="two-col">
                    <div class="one">
