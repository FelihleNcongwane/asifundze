...
<hr>
			...
			<p>The following example sets different padding for all four sides of a element:</p>
			<h4><b>Example</b></h4>
...
<hr>
			...
			<br>
			<a href="cssindex.php" class="btn"style="margin-left: 10px; margin-top: 5px;">Prepare>></a>
